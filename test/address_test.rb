...
class AddressTest < Minitest::Test
  def test_short_payload_generate
    ...
    assert_equal "ckt1qyqrdsefa43s6m882pcj53m4gdnj4k440axqswmu83", CKB::Address.generate(script, CKB::TESTNET)
    ...
    assert_equal "ckt1qyqlqn8vsj7r0a5rvya76tey9jd2rdnca8lqh4kcuq", CKB::Address.generate(script, CKB::TESTNET)
  end
  ...
  def test_full_payload_generate
    ...
    assert_equal "ckt1qsvf96jqmq4483ncl7yrzfzshwchu9jd0glq4yy5r2jcsw04d7xlydkr98kkxrtvuag8z2j8w4pkw2k6k4l5c02auef", CKB::Address.generate(script, CKB::TESTNET)
    ...
    assert_equal "ckt1q2n9dutjk669cfznq7httfar0gtk7qp0du3wjfvzck9l0w3k9eqhvdkr98kkxrtvuag8z2j8w4pkw2k6k4l5czshhac", CKB::Address.generate(script, CKB::TESTNET)
  end
