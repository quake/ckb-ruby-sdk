...
class WalletTest < Minitest::Test
  ...
  def test_gen_multisig_tx
    ...
    tx_builder = wallet.build("ckt1qyqywrwdchjyqeysjegpzw38fvandtktdhrs0zaxl4", 124_0000_0000, [0, 0, 2, 3, "0xc8328aabcd9b9e8e64fbc566c4385c3bdeb219d7".from_hex, "0x470dcdc5e44064909650113a274b3b36aecb6dc7".from_hex, "0x33fe4161344f2df80ab6f08d8a75d9b7d1d790b2".from_hex])
  ...
  def test_advance_build
    ...
    tx_builder = wallet.advance_build(
      "ckt1qyqr8ljpvy6y7t0cp2m0prv2whvm05whjzeqaydfze" => 1234_0000_0000,
      "ckt1qyq0myesdwxwntsra2m75xtp8k7q8nphjmksxyzz0c" => 4321_0000_0000,
